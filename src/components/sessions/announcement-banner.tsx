...
export default function AnnouncementBanner({
  ...
  const isTimeReached = useTargetDate("2025-11-06T18:00:00+05:45")
            ...
            <div className="py-3 sm:py-4">
              <div className="flex flex-col sm:flex-row items-center justify-between gap-3">
                  ...
                  <div className="flex flex-col sm:flex-row sm:items-center gap-2">
                    <div>
                      <span className="text-sm sm:text-base font-semibold text-emerald-900">
                        {meetingData ? "Japan Session by Bigyan Lama":"Upcoming Japan Session"}
                      </span>
                ...
                <div className="flex items-center gap-3">
                  ...
                  ): <AnnouncementBannerTimer targetDate="2025-11-06T18:00:00+05:45" /> : (
                    <Link
                      href="/sessions"
