      ...
      {mentorProfileWithUser.length === 0 ? (
        ...
        <>
          ...
          {mentorProfileWithUser.map((mentor) => (
            <div
              key={mentor.userId}
              className="bg-gray-200 py-5 px-7 rounded-lg flex flex-col gap-2 items-center"
            >
              <p>{mentor.user.name}</p>
              <div className="flex gap-1">
                Status:
                <p
                  className={`${mentor.verifiedStatus === "rejected" ? "text-red-500" : "text-blue-400"} capitalize`}
                >
              ...
              <div className="flex gap-2">
                <Link
                  ...
                  className="bg-blue-400 py-2 px-4 rounded-lg hover:bg-blue-500 transition-all duration-300 ease-in"
                >
                  View Details
                </Link>
              </div>
