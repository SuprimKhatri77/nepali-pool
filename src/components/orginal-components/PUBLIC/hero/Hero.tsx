...
export default function Hero() {
  return (
    <section className="h-auto mb-10 flex flex-col justify-start  items-center sm:pt-auto pt-12">
      ...
      <div className="m-10 yellow-box rounded-[8px] bg-gradient-to-b p-4 px-6 from-[#F0B100] to-[#FFD357] max-w-80 w-full stroke-white stroke-2 text-[#1F1777] ">
      ...
      <div className="max-w-[500px] w-full mx-auto text-center mt-6">
        ...
        <div className="cta flex justify-around text-base sm:text-xl font-semibold gap-4 sm:gap-10 mt-3">
          <button className="m-5 bg-[#FACC15] rounded-[10px] py-2 px-4 cursor-pointer">
            As a Mentor
          </button>
          <button className="m-5 bg-[#3a86ff] rounded-[10px] text-white py-2 px-4 cursor-pointer">
            As a Student
          </button>
        </div>
      </div>
