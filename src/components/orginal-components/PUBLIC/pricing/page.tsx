  ...
  return (
    ...
    >
      ...
      >
        <div
          id="freeCard"
          className="shadow-[8px_6px_6px_rgba(0,0,0,0.3)]  relative rounded-[8px] w-[315px] p-6 h-[500px] bg-gradient-to-b from-[#A800B7]  to-[#2F0D68] from-0% to-100%"
        >
          <h4 className="text-center font-medium text-2xl">Free Access</h4>
          <div id="price" className="flex items-center justify-center">
            <p className="text-center text-5xl font-bold mt-4">$0</p>
            <p className="text-center text-xl font-medium mt-2">per month</p>
          </div>
        ...
        <div
          id="premiumCard"
          className="shadow-[8px_6px_6px_rgba(0,0,0,0.3)] relative rounded-[8px] w-[361px]  p-6 h-[585px] bg-gradient-to-b from-[#FF4053]  to-[#260f55] from-0% to-100%"
        >
