export default function Pricing() {
  return (
    ...
    >
      <h1 className="text-4xl font-medium text-center">Pricing<span className="text-transparent bg-gradient-to-b from-red-600 to-red-700 bg-clip-text font-bold"> रु</span></h1>
      <div
      ...
      >
        ...
        >
          ...
          <div id="price" className="flex relative items-center justify-center">
            <p className="text-center text-5xl font-bold mt-4">$0/
