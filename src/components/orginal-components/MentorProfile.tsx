...
export default function MentorProfile() {
  return (
      <div className="bg-gradient-to-r from-[#BEDFFF] via-[#D1E9FF] to-white from-0% via-50% to-100% min-h-screen p-8">
            <div id="detail-container" className="bg-[#FBFBFB] max-w-[1200px] w-full min-h-[630px] shadow-md  mx-auto p-4 sm:p-8 rounded-3xl">
               <div id="main-details" className="flex flex-col lg:flex-row gap-4">
                   ...
                   <div id="details" className="max-w-[800px] w-full mt-6">
                       <div id="namerow" className="flex lg:justify-around ">
                          <h1 className="text-2xl sm:text-3xl md:text-5xl font-bold  text-[#1D293D]">Roshan Pokharel</h1>
