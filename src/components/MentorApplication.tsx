...
export default function ({ mentorProfileRecordWithUser }: { mentorProfileRecordWithUser: MentorProfileWithUserType }) {
    ...
    return (
        <div className="min-h-screen bg-gray-50 py-8">
            <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
                {/* Header */}
                <div className="mb-8">
                    <h1 className="text-3xl font-bold text-gray-900 mb-2">Mentor Application Review</h1>
                    <p className="text-gray-600">Review the application details and make a decision</p>
                </div>
                            ...
                            <CardContent className="space-y-4">
                                ...
                                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                                    ...
                                    <div className="flex items-center gap-2">
                                        ...
                                        <span className="text-sm">{mentorProfileRecordWithUser.user.email}</span>
                                    </div>

                                    <div className="flex items-center gap-2">
                                        <Phone className="h-4 w-4 text-gray-500" />
                                        <span className="text-sm font-medium">Phone:</span>
                                        <span className="text-sm">{mentorProfileRecordWithUser.phoneNumber}</span>
                                    </div>

                                    <div className="flex items-center gap-2">
                                        <MapPin className="h-4 w-4 text-gray-500" />
                                        <span className="text-sm font-medium">Country:</span>
                                        <span className="text-sm">{mentorProfileRecordWithUser.country}</span>
                                    </div>

                                    <div className="flex items-center gap-2">
                                        <MapPin className="h-4 w-4 text-gray-500" />
                                        <span className="text-sm font-medium">Nationality:</span>
                                        <span className="text-sm">{mentorProfileRecordWithUser.nationality}</span>
                                    </div>

                                    <div className="flex items-center gap-2">
                                        <MapPin className="h-4 w-4 text-gray-500" />
                                        <span className="text-sm font-medium">City:</span>
                                        <span className="text-sm">{mentorProfileRecordWithUser.city}</span>
                                    </div>
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                            ...
                            <Card>
                                ...
                                <CardContent>
                                    <div className="border rounded-lg overflow-hidden">
                                        <ClickableImage
                                            src={mentorProfileRecordWithUser.resume! || "/placeholder.svg"}
                                            height={400}
                                            width={400}
                            ...
                            <Card>
                                ...
                                <CardContent>
                                    <div className="border rounded-lg overflow-hidden">
                                        <ClickableImage
                                            src={mentorProfileRecordWithUser.citizenshipPhotoUrl! || "/placeholder.svg"}
