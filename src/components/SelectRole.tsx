...
export default function SelectRolePage() {
  ...
  return (
    <form
      action={formAction}
      className="flex flex-col gap-3 min-h-screen items-center justify-center"
    >
      <h1 className="text-xl font-bold">
        Looks like you missed out to select the role on sign-up??
      </h1>
      <p className="italic font-medium">
        No worreis though we have got you covered , You can do it now!
      </p>
      <div className="space-y-2 flex gap-2 items-center">
        <Label htmlFor="role" className="text-title text-sm">
          Role
        </Label>
