              ...
              <div className="flex gap-3">
                ...
                <div>
                  ...
                  <p className="text-sm text-orange-700 mt-1">
                    ...
                    experience. You're welcome to reapply in the future once
                    you've addressed the areas of improvement.
                  </p>
                </div>
              </div>
            </div>
          ...
          <CardContent className="space-y-3">
            ...
            <div className="flex items-start gap-3 p-3 rounded-lg bg-gray-50">
              ...
              <div>
                ...
                <p className="text-sm text-gray-600">
                  Profile content didn't align with our community guidelines
                </p>
              </div>
            </div>
          </CardContent>
        ...
        <Card className="border-green-200 bg-gradient-to-br from-green-50 to-emerald-50 mb-8">
          <CardContent className="text-center py-8">
            ...
            <p className="text-gray-600 mb-6 max-w-xl mx-auto">
              We believe in growth and second chances. When you're ready and
              have addressed the areas of improvement, we'd love to review your
              application again.
            </p>
        ...
        <Card className="border-gray-200 mb-8">
          ...
          <CardContent className="space-y-4">
            <div className="border-b border-gray-200 pb-4">
              ...
              <p className="text-sm text-gray-600">
                Absolutely! We encourage you to reapply once you've gained more
                experience or addressed the areas mentioned above. There's no
            ...
            <div className="border-b border-gray-200 pb-4">
              ...
              <p className="text-sm text-gray-600">
                For privacy and scalability reasons, we don't provide individual
                feedback. However, the common reasons listed above cover most
                scenarios.
              </p>
            </div>
            <div className="pb-2">
