              ...
              <div className="flex gap-3">
                ...
                <div>
                  ...
                  <p className="text-sm text-blue-700 mt-1">
                    ...
                    reviewed. You'll be notified whether you've been approved to
                    start mentoring or if we need additional information.
                  </p>
                </div>
              </div>
            </div>
          ...
          <Card className="border-gray-200">
            <CardHeader>
              <div className="flex items-center gap-3">
                ...
                <CardTitle className="text-lg">What We're Reviewing</CardTitle>
              </div>
            </CardHeader>
            ...
            <div className="space-y-6">
              ...
              <div className="flex gap-4">
                ...
                <div className="pb-8">
                  ...
                  <p className="text-sm text-gray-600 mt-1">
                    You'll receive an email with our decision within 24-48 hours
                  </p>
                </div>
              </div>
        ...
        <Card className="border-gray-200 mb-8">
          ...
          <CardContent className="space-y-4">
            ...
            <div className="border-b border-gray-200 pb-4">
              ...
              <p className="text-sm text-gray-600">
                If your application doesn't meet our current requirements, we'll
                send you detailed feedback. You're welcome to reapply after
