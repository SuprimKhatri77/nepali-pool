  ...
  return (
    <div className="min-h-screen bg-gradient-to-b from-white via-emerald-50/30 to-white">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        ...
        <Link
          href="/mentors"
          className="inline-flex items-center gap-2 text-sm text-slate-600 hover:text-emerald-600 transition-colors mb-8 group"
        >
        ...
        <div className="grid lg:grid-cols-3 gap-8 mb-16">
          ...
          <div className="lg:col-span-1">
            <Card className="border-slate-200 shadow-lg overflow-hidden sticky top-8">
                ...
                <div className="relative h-64 bg-gradient-to-br from-emerald-50 to-slate-50">
                  ...
                  {mentorRecord.verifiedStatus === "accepted" && (
                    <div className="absolute top-4 right-4">
                      <Badge className="bg-emerald-500 hover:bg-emerald-600 text-white border-0 shadow-lg flex items-center gap-1">
                ...
                <div className="grid md:grid-cols-2 gap-6">
                  ...
                  {mentorRecord.zipCode && (
                    <div>
                      ...
                      <p className="text-slate-900">{mentorRecord.zipCode}</p>
                    </div>
                  )}
              ...
              {otherSuggestedMentors.map((mentor) => (
                ...
                >
                  ...
                  <div className="p-6 space-y-4">
                    <div>
                      <h3 className="text-lg font-semibold text-slate-900 group-hover:text-emerald-600 transition-colors duration-300 line-clamp-1">
                        {mentor.user.name}
                      </h3>
                      {mentor.nationality && (
